<div class="space-y-4">
    <div>
        ...
        <input type="text" id="nombre" name="nombre" class="w-full px-4 py-2 bg-gray-50 border border-gray-100 rounded-xl text-sm focus:outline-none focus:border-[#7B1FA3] transition-all">
    </div>
    <div>
    ...
    <div>
        ...
        <input type="number" min="1" value="1" id="cantidad" name="cantidad_computadoras" class="w-full px-4 py-2 bg-gray-50 border border-gray-100 rounded-xl text-sm focus:outline-none focus:border-[#7B1FA3] transition-all">
    </div>
