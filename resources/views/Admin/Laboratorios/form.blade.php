<div class="space-y-4">
    ...
    <div>
        <label for="cantidad" id="label-cantidad" class="hidden block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Cantidad de Computadoras</label>
        <input type="number" min="1" value="1" id="cantidad" name="cantidad_computadoras" class="hidden w-full px-4 py-2 bg-gray-50 border border-gray-100 rounded-xl text-sm focus:outline-none focus:border-[#7B1FA3] transition-all" autocomplete="off">
    </div>
