...
<div>
    ...
    <input type="number" id="cantidad-edit" name="cantidad_total" min="1" class="w-full px-4 py-2 bg-gray-50 border border-gray-100 rounded-xl focus:outline-none focus:border-[#7B1FA3]" autocomplete="off">
</div>
<div>
