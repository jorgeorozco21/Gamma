            ...
            <main class="flex-1 flex flex-col overflow-hidden bg-[#F9FAFB]">
                ...
                <header class="bg-white border-b border-gray-100 px-4 md:px-8 py-4 flex justify-between items-center shrink-0">
                    ...
                    <div class="flex items-center gap-3">
                        <button id="reporte-modal" class="bg-[#7B1FA3] hover:bg-[#6A1B8E] text-white px-4 md:px-5 py-2 rounded-xl text-xs md:text-sm font-bold transition-all shadow-lg shadow-purple-100 flex items-center gap-2 active:scale-95">
