<div class="space-y-2 mb-6">
    ...
    <input type="text" id="nombre-usuario" name="nombre_usuario" autocomplete="off" value="{{ old('nombre_usuario') }}" class="w-full px-4 py-2 bg-gray-50 border border-gray-100 rounded-xl focus:outline-none focus:border-[#7B1FA3] transition-all">
</div>
<div class="space-y-2 mb-6">
    <label for="contrasena" class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Contraseña</label>
    <input type="password" id="contrasena" name="contrasena" autocomplete="off" class="w-full px-4 py-2 bg-gray-50 border border-gray-100 rounded-xl focus:outline-none focus:border-[#7B1FA3] transition-all">
</div>
