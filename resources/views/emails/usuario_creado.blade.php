<table width="100%" cellspacing="0" cellpadding="0" style="background-color: #f4f6f8; padding: 40px 20px;">
    <tr>
        <td align="center">
                ...
                <tr>
                    <td style="background-color: #7B1FA3; padding: 40px 30px; text-align: center;">
                        <h1 style="margin: 0; color: #ffffff; font-size: 24px; font-weight: 600; letter-spacing: 0.5px;">
                            ¡Te damos la bienvenida a Labores!
                        </h1>
                    </td>
                </tr>
                <tr>
                    <td style="padding: 40px 30px;">
                        ...
                        <p style="margin: 0 0 30px 0; font-size: 16px; line-height: 1.6; color: #4b5563;">
                            Tu cuenta ha sido creada correctamente en nuestra plataforma. A continuación, encontrarás tus credenciales de acceso:
                        </p>
                            ...
                            <tr>
                                <td style="padding: 20px;">
                                    ...
                                    <p style="margin: 0; font-size: 15px; color: #374151;">
                                        ...
                                        <span style="font-family: monospace; font-size: 16px; background-color: #f1f5f9; padding: 2px 6px; border-radius: 4px; color: #dc2626; font-weight: bold;">{{ $contrasena }}</span>
                                    </p>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table width="100%" cellspacing="0" cellpadding="0" style="border-top: 1px solid #e5e7eb; padding-top: 20px;">
                            <tr>
                                <td>
                                    <p style="margin: 0; font-size: 14px; line-height: 1.5; color: #6b7280; font-style: italic; text-align: center;">
                                        * Por motivos de seguridad, te solicitaremos cambiar esta contraseña la primera vez que inicies sesión.
                                    </p>
                                </td>
                            </tr>
                        </table>
