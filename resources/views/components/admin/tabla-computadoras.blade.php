        ...
        <table class="w-full text-left border-collapse min-w-[800px]">
            <thead>
                <tr class="border-b border-gray-100 bg-gray-50/50">
                    ...
                    <th class="px-6 py-4 text-[10px] font-bold text-gray-400 uppercase tracking-widest">Reportes </th>
            ...
            <tbody id="informacion-filtrada" class="divide-y divide-gray-50">
                @foreach ($computadoras as $computadora)
                    <tr class="hover:bg-gray-50/50 transition-colors group">
                        <td class="px-6 py-4 text-sm text-gray-600 font-medium">{{ $computadora->numero_computadora }}</td>
                        ...
                        <td class="px-6 py-4">
                            <button data-id="{{ $computadora->id }}" class="cambiar-estado flex items-center gap-2 p-2 rounded-lg text-sm text-gray-600 hover:text-[#7B1FA3] hover:bg-purple-50 transition-colors group">
                        ...
                        <td class="px-6 py-4">
                            <button data-id="{{ $computadora->id }}" class="reemplazar flex items-center gap-2 p-2 rounded-lg text-sm text-gray-600 hover:text-[#7B1FA3] hover:bg-purple-50 transition-colors">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
