<div class="flex flex-col md:flex-row justify-center items-center md:items-stretch gap-8 mb-24 max-w-6xl mx-auto px-6 md:px-0"> 
    @if (session('normal'))
        <div class="bg-white p-8 rounded-[32px] shadow-sm border border-gray-100 relative overflow-hidden group hover:shadow-xl hover:shadow-purple-500/10 transition-all duration-300">
            ...
            <a href="{{ route('activar.rol','normal') }}" class="w-full py-4 bg-gray-100 text-gray-500 rounded-2xl font-bold text-sm flex items-center justify-center gap-2 group-hover:bg-[#6A1B8E] group-hover:text-white transition-all">
    ...
    @if (session('encargado'))
        <div class="bg-white p-8 rounded-[32px] shadow-sm border border-gray-100 relative overflow-hidden group hover:shadow-xl hover:shadow-purple-500/10 transition-all duration-300">
            ...
            <p class="text-gray-400 text-sm leading-relaxed mb-10">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Explicabo nisi autem veniam exercitationem sapiente doloribus magnam vel repudiandae totam architecto, aliquid repellat quia atque, aperiam delectus praesentium porro animi quibusdam!</p>
            <a href="{{ route('activar.rol','encargado') }}" class="w-full py-4 bg-gray-100 text-gray-500 rounded-2xl font-bold text-sm flex items-center justify-center gap-2 group-hover:bg-[#6A1B8E] group-hover:text-white transition-all">
                Acceder <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"/></svg>
            </a>
        </div>
    @endif
    ...
    @if (session('mantenimiento'))
        <div class="bg-white p-8 rounded-[32px] shadow-sm border border-gray-100 relative overflow-hidden group hover:shadow-xl hover:shadow-purple-500/10 transition-all duration-300">
            ...
            <p class="text-gray-400 text-sm leading-relaxed mb-10">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Explicabo nisi autem veniam exercitationem sapiente doloribus magnam vel repudiandae totam architecto, aliquid repellat quia atque, aperiam delectus praesentium porro animi quibusdam!</p>
            <a href="{{ route('activar.rol','mantenimiento') }}" class="w-full py-4 bg-gray-100 text-gray-500 rounded-2xl font-bold text-sm flex items-center justify-center gap-2 group-hover:bg-[#6A1B8E] group-hover:text-white transition-all">
                Acceder <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"/></svg>
            </a>
        </div>
    @endif
