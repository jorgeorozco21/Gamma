<div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24 max-w-6xl mx-auto"> 
    <div class="bg-white p-8 rounded-[32px] border border-purple-100 relative overflow-hidden group">
        ...
        <a href="#" class="w-full py-4 bg-gray-100 text-gray-500 rounded-2xl font-bold text-sm flex items-center justify-center gap-2 hover:bg-[#6A1B8E] hover:text-white transition-all">
