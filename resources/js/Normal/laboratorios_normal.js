...
function generarTarjetas(informacion){
    ...
    informacion.forEach(laboratorio =>{
        tarjetas += `
            <a href="${ (laboratorio.tipo == 'prestamos')?`/usuario/normal/laboratorios/${laboratorio.id}-laboratorio-normal`:'/usuario/normal/laboratorios/#' }" class="flex flex-col gap-2 cursor-pointer">
